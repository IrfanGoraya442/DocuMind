...
with st.sidebar:
    ...
    st.caption("Powered by Groq Llama 3.3 + TF-IDF Search")
    st.divider()
    ...
    if os.environ.get("GROQ_API_KEY"):
        ...
        st.caption("Add `GROQ_API_KEY` to Streamlit secrets for AI answers.")
    ...
    st.divider()
    st.markdown(
        "<small>Built with Streamlit · Groq · scikit-learn</small>",
        unsafe_allow_html=True,
    )
